...
"""
TODO
Data Management can retrieve more data from graphs
This graphs can generate some necessary information for context analyther
Implement this interface to analyse the route options

<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  <key id="d25" for="edge" attr.name="est_width" attr.type="string" />
  <key id="d24" for="edge" attr.name="bridge" attr.type="string" />
  <key id="d23" for="edge" attr.name="ref" attr.type="string" />
  <key id="d22" for="edge" attr.name="junction" attr.type="string" />
  <key id="d21" for="edge" attr.name="tunnel" attr.type="string" />
  <key id="d20" for="edge" attr.name="service" attr.type="string" />
  <key id="d19" for="edge" attr.name="width" attr.type="string" />
  <key id="d18" for="edge" attr.name="access" attr.type="string" />
  ...
  <key id="d11" for="edge" attr.name="lanes" attr.type="string" />
